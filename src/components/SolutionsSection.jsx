...
import infineraLogo from "../assets/partners/infinera.png";
import aspectLogo from "../assets/partners/aspect.png";
import niceLogo from "../assets/partners/nice.png";
import sterliteLogo from "../assets/partners/sterlite.png";
...
const PARTNERS = [
  { name: "Infinera Coriant", logo: infineraLogo },
  { name: "Aspect", logo: aspectLogo },
  { name: "NICE", logo: niceLogo },
  { name: "Sterlite Tech", logo: sterliteLogo },
  { name: "Cisco", logo: ciscoLogo },
  { name: "Sprinklr", logo: sprinklrLogo }, // Replaced Ericsson with Sprinklr
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
            <h2
              className="font-display font-black text-[#0A1628] dark:text-white"
              style={{
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          {SERVICES.map((s, i) => (
            ...
            >
              ...
              <h3 className="font-display font-black text-[15px] mb-2 text-[#0A1628] dark:text-white">
                {s.title}
              </h3>
          ...
          >
            ...
            >
              {allPartners.map((partner, i) => (
                <div
                  key={i}
                  className="flex items-center justify-center px-6 py-3 rounded-xl border cursor-default transition-all duration-250 flex-shrink-0"
                  style={{
                    background: "#ffffff",
                    borderColor: "rgba(10,22,40,0.08)",
                    minWidth: "140px",
                ...
                >
                  <img
                    src={partner.logo}
                    alt={partner.name}
                    className="max-w-full max-h-10 w-auto object-contain"
